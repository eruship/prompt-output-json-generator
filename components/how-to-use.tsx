  ...
  return (
    <section className="border rounded-lg p-6 bg-card">
      ...
      <div className="space-y-6">
        <div>
          <h3 className="text-lg font-medium mb-2">What is Prompt JSON Generator?</h3>
          <p>
        ...
        <div>
          <h3 className="text-lg font-medium mb-2">Available Variable Types</h3>
        ...
        <div>
          ...
          <ol className="list-decimal pl-6 space-y-2">
            ...
            <li>For object and array types, you can add nested variables by clicking "Add Nested Variable".</li>
